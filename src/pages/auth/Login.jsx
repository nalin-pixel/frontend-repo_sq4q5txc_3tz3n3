  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <button className="w-full py-2 rounded bg-blue-600 hover:bg-blue-500">Sign in</button>
      </form>
      <p className="text-sm text-slate-400 mt-4">No account? <Link to="/signup" className="text-blue-400">Create one</Link></p>
    </div>
  )
}
